...
export default function AccessFlow({ initial = "welcome", canExit = false, onExit, onComplete }: Props) {
  ...
  return <main className="access-screen">
    ...
    {step === "welcome" && <section className="access-welcome">
      ...
      <div className="welcome-art"><div className="welcome-orbit orbit-one">ABC</div><div className="welcome-orbit orbit-two">★</div><img src="/cat-companion.png" alt="Miu chào đón bé"/><div className="welcome-card"><b>15 phút mỗi ngày</b><span>Học nhẹ nhàng · Tiến bộ đều</span></div></div>
    </section>}
