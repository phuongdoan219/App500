...
export default function LessonResult({ onMap, onReplay, onCat, onStreak, fish, streak, level, rewardMode }: Props) {
  return <main className="result-screen">
    ...
    <header className="result-topbar"><div className="road-brand"><span>V</span><div><b>VUIHOC</b><small>ENGLISH ADVENTURE</small></div></div><button onClick={onMap}><Map size={18} /> Về lộ trình</button></header>
